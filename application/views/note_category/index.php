<div id="page-wrapper">
    <div class="row">
        ...
        <div class="col-lg-2">
            <a href="<?php echo site_url('note/create'); ?>" class="page-header btn btn-success pull-right"> <?php echo $lang['add_category']; ?></a>
        </div>
    </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <?php foreach ($results as $note_item): ?>
                                <tr>
                                    <td><?php echo $i++; ?></td>
                                    <td><?php echo $note_item->name; ?></td>
                                    <td><?php echo $note_item->discription; ?></td>
                                    ...
                                    <td>
                                        ...
                                        <?php if ($this->session->userdata('is_logged_in')) { ?>
                                            ...
                                            <a href="<?php echo site_url('note/delete_category/' . $note_item->id); ?>"
