<div id="page-wrapper">
    <div class="row">
        ...
        <div class="col-lg-2">
            <a href="<?php echo site_url('note'); ?>" class="page-header btn btn-success pull-right"><?php echo $lang['note_list']; ?></a>
        </div>
    </div>
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <?php echo form_open_multipart('note/create', $attributes); ?>
                ...
                <div class="form-group <?php echo form_error('category_id') ? 'has-error' : '' ?>">
                    ...
                    <select class="form-control" name="category_id" id="">
                        ...
                        <option value="<?php echo $row['id'] ?>"><?php echo $row['discription'] ?></option>
